    ...
    <div className="relative min-h-screen overflow-hidden bg-[#070A10] pt-20 text-white">
      ...
      <main className="relative mx-auto max-w-4xl px-4 py-10 md:px-6 md:py-14">
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-xl text-sm leading-6 text-slate-500">Invoice dan status pembayaran ditampilkan dalam satu halaman. Jika gateway belum aktif, halaman tetap aman dan tidak akan freeze.</p>
        </div>
