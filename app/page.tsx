...
const services = [
  ...
  { icon: Film, title: "Alight Motion", text: "AM Premium 1 Tahun dengan pilihan Sharing otomatis dan Private proses manual.", href: "/store?product=alight-motion#order" },
]

export default async function Home() {
  // Memastikan collection MongoDB siap otomatis pada kunjungan pertama setelah deploy.
  await clientPromise
  ...
  return (
    <main className="min-h-screen bg-[#050914] text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 text-center md:px-6 md:py-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-slate-400 md:text-base">
            Panel Bot, Admin Panel, Redeem Code Redfinger, dan berbagai produk digital lainnya tersedia dalam satu tempat dengan pembayaran QRIS yang praktis dan proses yang cepat.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-4 pt-14 text-center md:px-6"><div className="text-xs font-black uppercase tracking-[.24em] text-cyan-300">More Than a Digital Store</div><h2 className="mx-auto mt-4 max-w-3xl text-3xl font-black md:text-4xl">Hari ini butuh satu. Besok, mungkin yang lain.</h2><p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-400">Brock Store hadir sebagai satu tempat untuk berbagai kebutuhan digitalmu. <strong className="text-slate-200">Produknya terus bertambah, cara belanjanya tetap mudah.</strong></p><p className="mt-3 font-black text-cyan-200">Satu Brock Store. Banyak kebutuhan.</p></section>
