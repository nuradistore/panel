    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;border:1px solid #e0e0e0;border-radius:8px">
        ...
        <div style="padding:20px;background:#f8f9fa">
          ...
          <div style="text-align:center;margin:20px 0"><a href="${panelUrl}" style="background:#e53e3e;color:white;padding:10px 20px;text-decoration:none;border-radius:5px;font-weight:bold">Login Sekarang</a></div>
          ...
          <div style="text-align:center;margin:20px 0"><a href="${appConfig.whatsappGroupLink}" style="background:#25D366;color:white;padding:10px 20px;text-decoration:none;border-radius:5px;font-weight:bold">Gabung Grup WhatsApp</a></div>
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;border:1px solid #e0e0e0;border-radius:8px">
        <div style="background:linear-gradient(to right,#06b6d4,#3b82f6,#8b5cf6);padding:15px;border-radius:8px 8px 0 0">
          <h2 style="color:white;margin:0;text-align:center">${appConfig.nameHost} - REDFINGER</h2>
        </div>
        <div style="padding:20px;background:#f8f9fa">
          <p>Halo,</p>
          <p>Terima kasih telah membeli produk REDFINGER di ${appConfig.nameHost}. Pembayaran Anda telah berhasil dan pesanan telah diproses secara otomatis.</p>
          ...
          <p>Silakan gunakan Redeem Code di atas untuk melakukan aktivasi pada REDFINGER.</p>
          <p>Pastikan Anda menyimpan kode dengan baik dan tidak membagikannya kepada orang lain.</p>
