    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
        ...
        <div style="padding: 20px; background-color: #f8f9fa;">
          ...
          <p>
            Terima kasih telah membeli panel Pterodactyl di ${appConfig.nameHost}.
            Berikut adalah detail akun panel Anda:
          </p>
          ...
          <div style="background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 5px; padding: 15px; margin: 20px 0;">
            ...
            <p>
              ...
              <code style="background-color: #f0f0f0; padding: 2px 4px; border-radius: 3px;">
                ${password}
              </code>
            </p>
            ...
            ${
              isAdmin
                ? `
                  <p>
                    <strong>Hak Akses:</strong> Administrator
                  </p>
                `
                : serverId !== null
                  ? `
            ...
            <p>
              ...
              <a href="${panelUrl}" style="color: #e53e3e;">
                ${panelUrl}
              </a>
            </p>
          </div>
          ...
          <div style="text-align: center; margin: 20px 0;">
            <a
              href="${panelUrl}"
              style="background-color: #e53e3e; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;"
            >
              Login Sekarang
            </a>
          </div>
          ...
          <p>
            Anda juga dapat bergabung dengan grup WhatsApp kami
            untuk mendapatkan informasi terbaru dan dukungan:
          </p>
        ...
        <div style="background-color: #2d3748; color: white; text-align: center; padding: 10px; border-radius: 0 0 5px 5px;">
          <p style="margin: 0;">
            &copy; ${new Date().getFullYear()} ${appConfig.nameHost}.
            All rights reserved.
          </p>
        </div>
      </div>
