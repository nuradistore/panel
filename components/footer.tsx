        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://lynk.id/" className="text-gray-400 hover:text-red-500 transition-colors">
                  Admin Panel
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://youtube.com/@brockstoreel" className="text-gray-400 hover:text-red-500 transition-colors">
                  YouTube (BROCK STORE)
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="https://instagram.com/nuradistore" className="text-gray-400 hover:text-red-500 transition-colors">
                  Instagram
                </Link>
              </li>
              <li>
