              ...
              {plan ? (
                plan.category === "admin-panel" ? (
                  <div className="text-sm">
                    <p className="text-gray-400">Jenis Akses</p>
                    <p className="font-medium text-white">Administrator Pterodactyl</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                    <div><p className="text-gray-400">RAM</p><p className="font-medium text-white">{plan.memory === 0 ? "Unlimited" : `${plan.memory} MB`}</p></div>
                    <div><p className="text-gray-400">Disk</p><p className="font-medium text-white">{plan.disk === 0 ? "Unlimited" : `${plan.disk} MB`}</p></div>
                    <div><p className="text-gray-400">CPU</p><p className="font-medium text-white">{plan.cpu === 0 ? "Unlimited" : `${plan.cpu}%`}</p></div>
                  </div>
                )
              ) : (
