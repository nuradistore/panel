      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-white md:text-4xl">Bukan cuma jual panel.</h2>
            <p className="mt-4 max-w-md text-sm leading-7 text-slate-500">Tampilan baru ini dibuat lebih fokus ke informasi yang penting: kategori, spesifikasi, harga, dan proses beli.</p>
          </div>
