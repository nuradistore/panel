...
export function QrPayment({
  ...
  const saveTransactionToHistory = (status: "pending" | "paid" | "processing" | "completed" | "failed", details?: any) => {
    try {
  ...
  useEffect(() => {
    saveTransactionToHistory(initialStatus, initialPanelDetails)
  }, [])
  ...
  return (
    <div className="space-y-6 relative">
          ...
          <Card className="overflow-hidden border-cyan-300/10 bg-[#0A1020]">
            ...
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="bg-white p-4 rounded-2xl shadow-md border border-white/8 mx-auto md:mx-0">
                  <Image
                ...
                <div className="flex-1 space-y-6">
                  <div className="bg-[#070B15] p-4 rounded-2xl border border-white/8">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between font-medium">
                        ...
                        <span className="text-cyan-200">{formatRupiah(total)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <Button
                    onClick={checkStatus}
                    disabled={isChecking}
                    className="w-full h-12 flex items-center justify-center bg-gradient-to-r from-cyan-300 to-sky-400 hover:brightness-110 text-[#041017] font-black"
                  >
                    {isChecking ? (
                      <>
      ...
      {(status === "paid" || status === "processing") && (
        ...
        >
          <Card className="overflow-hidden border-cyan-300/10 bg-[#0A1020]">
            <div className="bg-gradient-to-r from-sky-400/20 to-cyan-400/10 text-white p-4">
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-[#070B15] p-4 rounded-2xl border border-white/8 mb-4">
      ...
      {status === "completed" && (
        ...
        >
          <Card className="overflow-hidden border-cyan-300/10 bg-[#0A1020]">
            <div className="bg-gradient-to-r from-emerald-400/20 to-cyan-400/10 text-white p-4">
              <h3 className="font-medium flex items-center justify-center">
                ...
                <div className="bg-[#070B15] p-4 rounded-2xl border border-white/8 mb-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="bg-black/20 px-3 py-2 rounded text-gray-300 text-sm font-mono break-all">
                    ...
                    <div>
                      ...
                      <div className="bg-black/20 px-3 py-2 rounded text-gray-300 text-sm font-mono">
                    ...
                    {panelDetails.type === "admin-panel" || panelDetails.serverId === null ? (
                      <div>
                        <div className="flex justify-between items-center mb-1"><span className="text-gray-400 text-sm">Hak Akses:</span></div>
                        <div className="bg-black/20 px-3 py-2 rounded text-gray-300 text-sm font-mono">Administrator</div>
                      </div>
                    ) : (
                      <div>
                        <div className="flex justify-between items-center mb-1">
                        ...
                        <div className="bg-black/20 px-3 py-2 rounded text-gray-300 text-sm font-mono">{panelDetails.serverId}</div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-4">
                    <a
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-300 to-sky-400 text-[#041017] py-2 px-4 rounded-xl font-black transition-colors"
                    >
      ...
      {status === "failed" && (
        <Card className="overflow-hidden border-cyan-300/10 bg-[#0A1020]">
          ...
          <CardContent className="p-6 text-center">
            ...
            <Button onClick={() => (window.location.href = "/")} className="bg-gradient-to-r from-cyan-300 to-sky-400 text-[#041017] font-black h-12 rounded-xl">
      ...
      {status === "pending" && isExpired && (
        <Card className="overflow-hidden border-cyan-300/10 bg-[#0A1020]">
          <div className="bg-gradient-to-r from-amber-400/20 to-orange-400/10 text-white p-4">
            <h3 className="font-medium flex items-center justify-center">
              <AlertCircle className="mr-2 h-5 w-5" />
