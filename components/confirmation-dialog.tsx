      ...
      <DialogContent className="overflow-hidden border-cyan-300/15 bg-[#0A1020] p-0 text-white shadow-[0_30px_100px_rgba(0,0,0,.55)] sm:max-w-md">
        ...
        <div className="p-5 sm:p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-500">Periksa paket sebelum masuk ke proses pembayaran.</DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-5 rounded-[22px] border border-white/8 bg-[#070B15] p-4">
            ...
            <p className="mt-1 text-2xl font-black text-cyan-200">{formatRupiah(plan.price)}</p>
            ...
            <p className="mt-4 text-xs leading-5 text-slate-500">{plan.description}</p>
          </div>
