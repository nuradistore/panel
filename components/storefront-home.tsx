...
const hero = {
  ...
  "alight-motion": { eyebrow: "AM PREMIUM 1 TAHUN", title: "Premium lebih lama.", accent: "Harga tetap hemat.", text: "Pilih AM Premium Sharing dengan pengiriman akun otomatis atau Private yang diproses manual oleh admin." },
} satisfies Record<
  StoreCategory,
  {
    eyebrow: string
...
const loggedInHero = [
  ...
  },
  {
    ...
    text: "Berbagai produk digital tersedia dan dapat dibeli langsung dari akun kamu.",
  },
  {
...
export function StorefrontHome({
  user,
  initialCategory = "panel-bot",
}: {
  user?: AccountUser | null
  initialCategory?: StoreCategory
}) {
  const [activeCategory, setActiveCategory] =
    useState<StoreCategory>(initialCategory)
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <div className="mt-8 grid max-w-lg grid-cols-3 gap-3">
              <MiniStat
                ...
                label={
                  activeCategory === "alight-motion" ? "AM Ready" : activeCategory === "redfinger"
                    ? "Code Ready"
                    : activeCategory === "admin-panel"
                      ? "Admin Ready"
                      : "Bot Ready"
              ...
              <MiniStat
                ...
                label={
                  activeCategory === "alight-motion" ? "1 Tahun" : activeCategory === "redfinger"
                    ? "Kirim Instan"
                    : "Fast Setup"
                }
              />
              ...
              <MiniStat
                ...
                label={
                  activeCategory === "alight-motion" ? "Sharing/Private" : activeCategory === "redfinger"
                    ? "Code Aman"
                    : "Secure"
                }
              />
            ...
            >
              {activeCategory === "alight-motion" ? "Pilih AM Premium sekarang" : activeCategory === "redfinger"
